...
namespace Fungus.EditorUtils
{
    ...
    public class PortraitEditor : CommandEditor
    {
        ...
        public override void DrawCommandGUI()
        {
            ...
            CommandEditor.ObjectField<Character>(characterProp, //array選擇角色
            ...
            if (t.Display != DisplayType.None && t._Character != null && showOptionalFields)
            {
                if (t.Display != DisplayType.Hide && t.Display != DisplayType.MoveToFront)
                {
                    ...
                    CommandEditor.ObjectField<Sprite>(portraitProp,
                                                      ...
                                                      t._Character.Portraits);//這裡在spine要抓的是動畫
                ...
                if (t._Portrait != null && t.Display != DisplayType.Hide)//中間的顯示圖片
                {
                ...
                if (t.Display != DisplayType.Hide)//更換圖片<- ->
                {
