...
namespace Fungus.EditorUtils
{
    ...
    public class VariableSelectPopupWindowContent : BasePopupWindowContent
    {
        ...
        static public void DoAddVariable(Rect position, string currentHandlerName, Flowchart flowchart)//顯示值類型下拉選單
        {
        ...
        public VariableSelectPopupWindowContent(string currentHandlerName, int width, int height)//數值頁面點選加號後的數值類型的下拉選單
